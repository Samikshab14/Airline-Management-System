...
public class DisplayAll extends javax.swing.JFrame {
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		...
		//String status,flightdate,amount = null;
		try
		...
		String[] columnNames = {"ID","Cust_id", "Name", "Flight Number","Departure","Arrival","Flight Date","Amount"};
		...
		while(cursor.hasNext()) {
			...
			flightdate = (String)obj.get("flight_date");
			amount = (String)obj.get("amount");
			//String address = (String)obj.get("address");
			
			String flightno=(String)obj.get("flight_no");

			search.put("flight_no",flightno);
			cursor2 = coll2.find(search);
			System.out.println(cursor2);
			System.out.println(cursor2.hasNext());
			if(cursor2.hasNext())
			{
				DBObject search1=cursor2.next();

				//status=(String)obj.get("status");
				dep = (String)search1.get("flight_dept");
//				System.out.println(dep);
//				System.out.println(arr);
				arr = (String)search1.get("flight_arrival");
			...
			model.addRow(new Object[] { id,cust_id,name,flightno,dep,arr,flightdate,amount});
